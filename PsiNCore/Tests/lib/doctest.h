...
// for clang - always lib ciso646 (which drags some std stuff) because
...
struct ContextOptions //!OCLINT too many fields
{
    ...
    bool success;              // lib successful assertions in output
...
DOCTEST_CLANG_SUPPRESS_WARNING("-Wnonportable-system-lib-path")
...
// =================================================================================================
// The following code has been taken verbatim from Catch2/lib/internal/catch_xmlwriter.h/cpp
    ...
    struct ConsoleReporter : public IReporter
    {
        ...
        void printHelp() {
            ...
            s << " -" DOCTEST_OPTIONS_PREFIX_DISPLAY "s,   --" DOCTEST_OPTIONS_PREFIX_DISPLAY "success=<bool>                "
              << Whitespace(sizePrefixDisplay*1) << "lib successful assertions in output\n";
